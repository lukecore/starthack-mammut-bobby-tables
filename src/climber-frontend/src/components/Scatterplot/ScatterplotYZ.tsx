...
class ScatterplotYZ extends React.Component {
  ...
  data = [
    //Shape of the route
    { data: [{ x: 0, y: 1 }, { x: 0, y: 1.5 }, { x: 0, y: 1.75 }, { x: -0.25, y: 2.25 }, { x: -0.5, y: 2.50 }, { x: -0.75, y: 3 }, { x: -1, y: 3.75 }, { x: -1, y: 4.75 }, { x: -1, y: 6 }, { x: -1.5, y: 7 }, { x: -1.5, y: 8 }, { x: -0.5, y: 9 }, { x: 0, y: 9 }], backgroundColor: this.colors.wall, borderWidth: 0, showLine: true, borderColor: this.colors.wall, pointRadius: 0, label:"shape", showTooltips: false },
    //Used handles
